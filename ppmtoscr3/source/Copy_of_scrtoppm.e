...
col:=0
IF ((ppmmem[blk+6144]) AND 64) THEN bright:=1 ELSE bright:=0
IF ((ppmmem[blk+6144]) AND 128) THEN flash:=1 ELSE flash:=0

IF papink=0
	IF ((ppmmem[blk+6144]) AND 1) THEN col:=1
	IF ((ppmmem[blk+6144]) AND 2) THEN col:=2
	IF ((ppmmem[blk+6144]) AND 3) THEN col:=3
	IF ((ppmmem[blk+6144]) AND 4) THEN col:=4
	IF ((ppmmem[blk+6144]) AND 5) THEN col:=5
	IF ((ppmmem[blk+6144]) AND 6) THEN col:=6
	IF ((ppmmem[blk+6144]) AND 7) THEN col:=7
ELSE
	IF ((ppmmem[blk+6144]) AND 8) THEN col:=1
	IF ((ppmmem[blk+6144]) AND 16) THEN col:=2
	IF ((ppmmem[blk+6144]) AND 24) THEN col:=3
	IF ((ppmmem[blk+6144]) AND 32) THEN col:=4
	IF ((ppmmem[blk+6144]) AND 40) THEN col:=5
	IF ((ppmmem[blk+6144]) AND 48) THEN col:=6
	IF ((ppmmem[blk+6144]) AND 56) THEN col:=7
ENDIF
ENDPROC
